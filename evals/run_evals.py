...
BAD_CASES = [
    ...
    ("populated static hook", "Strength that fits a packed week", "static_hook", "static-hook-blank"),
    ...
    ("hook filler opener, okay", "Okay, twenty percent off your first block with me", "video_hook", "hook-filler-opener"),
    ("hook filler opener, real quick", "Real quick, because I see this with almost every busy professional I meet", "video_hook", "hook-filler-opener"),
...
GOOD_CASES = [
    ...
    ("blank static hook cell", "", "static_hook"),
    ("single unlabelled tracker hook cell", "Training keeps falling off your week", "hook_cell"),
    ("hook opening on the offer", "Twenty percent off your first block of personal training with me", "video_hook"),
    ("okay later in a hook is not an opener", "See this plate? Okay, twenty kilos", "video_hook"),
