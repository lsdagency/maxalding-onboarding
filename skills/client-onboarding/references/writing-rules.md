...
- **The list of three.** "They sit a lot, they travel a lot, and many of them have kids." "Energy for the whole day, a strong back, and to keep up with their kids." "Tap the button, leave your details, and I'll message you." Three parallel items, the last joined with "and", is the rhythm a writer reaches for to make a line feel finished, and a script full of them sounds composed rather than said (Feedback 2026-09-25, Colossus PT: five in one short draft, bodies and CTAs, after the hooks had already been cleaned). One in a script is plenty. Use a pair or a single idea, and split a three-step CTA into two plain sentences ("Tap the button and leave your details. I'll message you to find a time."). Count them across bodies and CTAs, not only hooks; a genuine list of facts (the areas on a map, what is in a package) is not the shape.
...
Signals worth counting off the transcript: how often they say yeah, mate, look, right, alright, okay, reckon, gonna, gotta. Those fillers are evidence of register for the BODY; a hook never opens on one (see script-guidelines.md). Whether they use tag questions. Whether they repeat for emphasis. How long their average sentence is. A coach who says "as hard as you can, as hard as you can" and "drive, drive, drive" does not then say "which is exactly why the approach works".
...
**Positive connotations run through every line, not only the hooks** (Feedback 2026-09-25, Colossus PT). Once hooks are rewritten gain-led, the negativity tends to move into the bodies, CTAs, static sublines and interview questions: "they sit a lot", "a bad night", "we don't start from zero", "any pain or old injuries", "Long days at a desk?", "What had you tried before?". None of those blames the person, so the positive-language rule passes them. Run the gain-led classification over every spoken line, CTA, static subline and interview question too. Describe what the person wants and what happens next ("we change the session and keep going", "we talk about your week and what you want from your training"), and let interview questions ask why they started and what changed rather than what went wrong before.
