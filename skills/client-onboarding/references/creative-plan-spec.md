...
- Emoji and length are fluid and intentional, never a pattern. Use a few emoji across the set where they genuinely fit and leave some posts with none, leaning slightly toward more rather than too few, never one-per-row. Do not pad copy to reach the character limit: if shorter reads stronger, keep it shorter.
